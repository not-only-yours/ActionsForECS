...
module "fargate-frontend" {
  ...
  ecr_repository_arn = aws_ecr_repository.ecr-frontend.arn
  task_container_image   = "${aws_ecr_repository.ecr-frontend.repository_url}:${var.FRONTEND_CONTAINER_IMAGE}"
